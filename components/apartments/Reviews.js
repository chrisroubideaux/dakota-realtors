        ...
        <div className="pt-4">
          ...
          <div className="container pt-5 mt-4">
            ...
            <p className="text-center lead mt-5 fs-4 fw-normal">
              ...
              Check out our wide variety of luxurious apartments,from cozy,
              studio and 1 bed apartments to our beauiful 2 & 3 bed spacious
              aparmtents. Book an appointment today with one of our experienced
              agents & create an account today.
            </p>
          </div>
        </div>
      </div>
